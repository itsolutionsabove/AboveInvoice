...
<style>
    @font-face {
        font-family: Cairo;
        src: url("{{ url('fonts/Cairo-VariableFont_slnt.ttf') }}");
    }
    * {
        margin: 0;
        padding: 0;
...
<body>
<div class="overlay">
    {{--    <img style="width: 100% ; height: 100%; display: block" src="{{url('invoice.png')}}" alt="" class="bg-img" />--}}
    <img style="width: 100% ; height: 100%; display: block" src="{{url('hover.jpeg')}}" alt="" class="bg-img" />
</div>

<img style="height: 100px; width: 100%" src="{{url('nav.jpeg')}}" alt="" />
              ...
              "
                >
                    <div>
                        ...
                        <div>بنك البلاد, فرع النسيم الشرقي, شارع حسان بن ثابت</div>
                        <div>
                            <img style="width: 100px; height: 100px" src="{{url('qr.png')}}" alt="" />
                        </div>
                    </div>
                </th>
            @else
...
<img style="width: 100% ; height: 100px ; position: fixed; left: 0;bottom: 0" src="{{url('footer.jpeg')}}" alt="" />
