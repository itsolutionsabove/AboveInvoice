            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="{{url('admin/new-orders')}}" wire:navigate>
                                    New Orders
                                </a>
                            </div>
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="{{url('admin/accepted-orders')}}" wire:navigate>
                                    Active Orders
                                </a>
                            </div>
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="{{url('admin/completed-orders')}}" wire:navigate>
                                    Completed Orders
                                </a>
                            </div>
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="{{url('admin/canceled-orders')}}" wire:navigate>
                                    Canceled Orders
                                </a>
                            </div>
                        </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" href="{{url('admin/settings')}}" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false" >
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#{{url('admin/sign-out')}}" role="button" wire:navigate>
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
