        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    @if($this->__name == "opinion-edit")
                        <h4 class="card-title">Edit Opinion</h4>
                    @else
                        <h4 class="card-title">Add Opinion</h4>
                    @endif
                </div>
                <div class="card-body">
                    <form>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Comment AR</label>
                            <textarea wire:model="comment_ar" class="form-control"
                                   autocomplete="off"></textarea>
                            @error('comment_ar') <span class="text-danger error">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-3">
